...
class _PageClientsState extends State<PageClients> {
  ...
  Future _getData() async {
    List<Client> data = await ClientProvider.shared.getAll(context);
    ...
    return Scaffold(
        ...
        body: FutureBuilder(
          future: ApiManager.shared.request(
              baseUrl: "10.0.2.2:9595", pathUrl: "/cliente/buscar", type: HttpType.GET),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Column(
                          children: [
                            RowData(
                              idData1: 'Id:',
                              valueData1: list[index].dniCl.toString(),
                              idData2: 'email:',
